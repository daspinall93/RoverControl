...
//My defines
//PWM settings
//Need to re-do these calibartions!!!
#define IMU_ACC_XCAL  556
#define IMU_ACC_YCAL  556
#define IMU_ACC_ZCAL  556
#define IMU_GYR_XCAL  556
#define IMU_GYR_YCAL  556
#define IMU_GYR_ZCAL  556

#define IMU_SAMPLE_RATE_NODLPF	7 //IMU sample rate
#define IMU_EXT_FSYNC_OFF	0 //disable FSYNC

//IMU address on I2C bus
#define IMU_ADDR  0x68

//imu high level
//functions that use set and get functions
void imu_enable();
void imu_disable();
void imu_calibrate();
...
void imu_getAcceleration(int16_t*);
void imu_getRotation(int16_t*);
