...
static void mavlink_test_locom_command(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_locom_command_t packet1, packet2;
        ...
        packet1.Locom_commandid = packet_in.Locom_commandid;
    ...
    mavlink_msg_locom_command_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_locom_command_pack(system_id, component_id, &msg , packet1.Locom_commandid , packet1.duration_ms , packet1.power );
    mavlink_msg_locom_command_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_locom_command_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.Locom_commandid , packet1.duration_ms , packet1.power );
    mavlink_msg_locom_command_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_locom_command_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_locom_command_send(MAVLINK_COMM_1 , packet1.Locom_commandid , packet1.duration_ms , packet1.power );
    mavlink_msg_locom_command_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
