...
#define MAVLINK_MESSAGE_CRCS {{0, 176, 4, 0, 0, 0}, {3, 231, 14, 0, 0, 0}, {4, 194, 9, 0, 0, 0}, {5, 181, 17, 0, 0, 0}, {10, 47, 12, 0, 0, 0}, {11, 43, 10, 0, 0, 0}}
#endif
...
# define MAVLINK_MESSAGE_INFO {MAVLINK_MESSAGE_INFO_HEARTBEAT, MAVLINK_MESSAGE_INFO_LOCOM_COMMAND, MAVLINK_MESSAGE_INFO_LOCOM_REPORT, MAVLINK_MESSAGE_INFO_LOCOM_STATE, MAVLINK_MESSAGE_INFO_MOTOR_COMMAND, MAVLINK_MESSAGE_INFO_MOTOR_REPORT}
# define MAVLINK_MESSAGE_NAMES {{ "HEARTBEAT", 0 }, { "LOCOM_COMMAND", 3 }, { "LOCOM_REPORT", 4 }, { "LOCOM_STATE", 5 }, { "MOTOR_COMMAND", 10 }, { "MOTOR_REPORT", 11 }}
