...
#define MAVLINK_MSG_ID_SONAR_REPORT_CRC 91
#define MAVLINK_MSG_ID_27_CRC 91
...
/**
 * @brief Get field object_detected_flag from sonar_report message
 *
 * @return 
 */
static inline uint8_t mavlink_msg_sonar_report_get_object_detected_flag(const mavlink_message_t* msg)
{
