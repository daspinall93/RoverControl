...
static void mavlink_test_heartbeat(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_msg_heartbeat_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_heartbeat_pack(system_id, component_id, &msg , packet1.motor_mode , packet1.modeDur_ms , packet1.pitch_deg , packet1.roll_deg , packet1.yaw_deg , packet1.tiltFlag , packet1.objDetFlag , packet1.objDist_cm );
    mavlink_msg_heartbeat_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_heartbeat_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.motor_mode , packet1.modeDur_ms , packet1.pitch_deg , packet1.roll_deg , packet1.yaw_deg , packet1.tiltFlag , packet1.objDetFlag , packet1.objDist_cm );
    mavlink_msg_heartbeat_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_heartbeat_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_heartbeat_send(MAVLINK_COMM_1 , packet1.motor_mode , packet1.modeDur_ms , packet1.pitch_deg , packet1.roll_deg , packet1.yaw_deg , packet1.tiltFlag , packet1.objDetFlag , packet1.objDist_cm );
    mavlink_msg_heartbeat_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_inert_command(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_msg_inert_command_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_inert_command_pack(system_id, component_id, &msg , packet1.newCommand );
    mavlink_msg_inert_command_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_inert_command_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.newCommand );
    mavlink_msg_inert_command_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_inert_command_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_inert_command_send(MAVLINK_COMM_1 , packet1.newCommand );
    mavlink_msg_inert_command_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_sonar_command(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_msg_sonar_command_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_sonar_command_pack(system_id, component_id, &msg , packet1.newCommand );
    mavlink_msg_sonar_command_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_sonar_command_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.newCommand );
    mavlink_msg_sonar_command_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_sonar_command_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_sonar_command_send(MAVLINK_COMM_1 , packet1.newCommand );
    mavlink_msg_sonar_command_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_sonar_report(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_sonar_report_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.objectDistance_cm = packet_in.objectDistance_cm;
        packet1.objectDetected_flag = packet_in.objectDetected_flag;
    ...
    mavlink_msg_sonar_report_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_sonar_report_pack(system_id, component_id, &msg , packet1.objectDetected_flag , packet1.objectDistance_cm );
    mavlink_msg_sonar_report_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_sonar_report_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.objectDetected_flag , packet1.objectDistance_cm );
    mavlink_msg_sonar_report_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_sonar_report_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_sonar_report_send(MAVLINK_COMM_1 , packet1.objectDetected_flag , packet1.objectDistance_cm );
    mavlink_msg_sonar_report_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
