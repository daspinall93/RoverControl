...
class MAVLink_heartbeat_message(MAVLink_message):
        ...
        ordered_fieldnames = [ 'modeDur_ms', 'pitch_deg', 'roll_deg', 'yaw_deg', 'objDist_cm', 'motor_mode', 'tiltFlag', 'objDetFlag', 'mavlink_version' ]
        format = '<IffffBBBB'
        native_format = bytearray('<IffffBBBB', 'ascii')
        orders = [5, 0, 1, 2, 3, 6, 7, 4, 8]
        ...
        def pack(self, mav, force_mavlink1=False):
                return MAVLink_message.pack(self, mav, 76, struct.pack('<IffffBBBB', self.modeDur_ms, self.pitch_deg, self.roll_deg, self.yaw_deg, self.objDist_cm, self.motor_mode, self.tiltFlag, self.objDetFlag, self.mavlink_version), force_mavlink1=force_mavlink1)
